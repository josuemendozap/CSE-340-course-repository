...
const createProject = async (title, description, location, date, organizationId) => {
  ...
  if (process.env.ENABLE_SQL_LOGGING === 'true') {
    console.log('Create new project with ID:', result.rows[0].project_id);
  }
...
export { getAllProjects, getProjectsByOrganizationId, getUpcomingProjects, getProjectDetails, getCategoryByProjectId, createProject, updateProject };